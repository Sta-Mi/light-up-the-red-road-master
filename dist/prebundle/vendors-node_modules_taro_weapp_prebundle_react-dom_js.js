...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-ZHRCXMCT.js */ "./node_modules/.taro/weapp/prebundle/chunk-ZHRCXMCT.js")["nav"];
...
(0,_chunk_ZHRCXMCT_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_ZHRCXMCT_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
...
var hostConfig = {
    ...
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_ZHRCXMCT_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_ZHRCXMCT_js__WEBPACK_IMPORTED_MODULE_1__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_ZHRCXMCT_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createTextNode(text);
